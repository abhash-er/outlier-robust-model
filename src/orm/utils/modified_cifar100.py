...
from torchvision.datasets.utils import check_integrity, download_url  # type: ignore
    ...
    def __init__(
        ...
        if self.train:
            ...
            self.train_data = (self.train_data.
                               reshape((50000, 3, 32, 32))  # type: ignore
                            )
            # fmt: on
            self.train_data = self.train_data.transpose((0, 2, 3, 1))  # type: ignore
        else:
